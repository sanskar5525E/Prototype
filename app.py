...
st.set_page_config(page_title="Wholesale Credit Risk Dashboard (Demo)", layout="wide")
st.title("📊 Wholesale Customer Risk Dashboard (Demo)")
...
# Main app: always use example data for demo
df_raw = generate_example_data()
st.info("📌 This is a demo using example data.")
